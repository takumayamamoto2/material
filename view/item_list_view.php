        ...
        <div class="back-color-nav">
            <nav class="width-900">
                ...
                <form method="post">
                    ...
                    <div class="flex">
                        <div class="normal-border flex">
                        <form method="post" class="flex-para">
                            <input class="<?php if($type_bind == ITEM_TYPE['illust']){ print 'red-text-button margin'; } else { print 'gray-text-button margin';}?>" type="submit" value="イラスト">
                            <input type="hidden" name="illust" value="<?php print ITEM_TYPE['illust']; ?>">
                        </form>
                        <form method="post" class="flex-para">
                            <input class="<?php if($type_bind == ITEM_TYPE['music']){ print 'red-text-button margin'; } else { print 'gray-text-button margin';}?>" type="submit" value="BGM・効果音">
                            <input type="hidden" name="music" value="<?php print ITEM_TYPE['music']; ?>">
                        </form>
                        </div>
                ...
                <dl class="flex-wrap">
                    ...
                    <div class="margin">
                        <form action="details.php" method="post">
                            <?php if($type_bind == ITEM_TYPE['illust']){
                            print '<dt><input type="image" name="submit" class="img-lock" src=" ' ?> <?php print IMG_PATH . $value['filename']; ?> <?php print ' "></dt>';
                            }?>
                            <?php if($type_bind == ITEM_TYPE['music']){
                            print '<dt><input type="image" name="submit" class="img-lock" src=" ' ?> <?php print IMG_PATH . 'noimage.png'; ?> <?php print ' "></dt>';
                            }?>
                            <dd class="bold-text"><?php print $value['name']; ?></dd>
                            <dd>種類：<?php print $value['type2']; ?></dd>
                        ...
                        <?php } else { ?>
                        <form method="post" action="item_list_add_cart.php">
